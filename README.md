...
|--------------------------|--------------------------|------------------|
| Trabaja con objetividad, eficiencia y eficacia en equipos multidisciplinarios enfocados en proyectos de ingeniería de software. | **Jorge Luis Díaz Fiestas**<br>**TB1:**<br>Durante el desarrollo del TB1, mi principal aporte fue el apoyo en la construcción de la Landing Page de nuestro producto, tanto en la definición del contenido como en su estructura visual. Además, colaboré activamente en el diseño de la interfaz en Figma, aportando ideas y ajustes que ayudaron a consolidar la propuesta visual final del equipo.<br>**TP:** | Durante el desarrollo del proyecto, el uso de herramientas como Figma, Miro y GitHub fue clave para facilitar la colaboración en equipo y organizar el trabajo de forma eficiente. Figma resultó especialmente útil para diseñar prototipos de alta fidelidad, gracias a sus funciones colaborativas en tiempo real. Miro nos permitió estructurar ideas, definir escenarios y mapear experiencias de usuario de manera visual.<br>Además, la planificación a través del product backlog nos dio una visión clara de las tareas prioritarias y mejoró la coordinación entre los miembros del equipo. Las entrevistas con usuarios reforzaron la importancia de la empatía y la escucha activa para adaptar el producto a sus necesidades reales.<br>Finalmente, la elaboración del video del equipo nos permitió reflexionar sobre nuestro proceso y detectar oportunidades de mejora para proyectos futuros. |
| | **Paulo Percy Quincho Gamarra**<br>**TB1:**<br>Durante el desarrollo del TB1, mi principal aporte fue el apoyo en la construcción de la Landing Page del producto, participando en la definición del contenido y en su estructura visual. También colaboré en la implementación de los wireframes y en la elaboración de los diagramas necesarios para representar de forma clara la experiencia del usuario y el flujo de navegación.<br>**TP:** | |
| | **Alexander Piero Fernandez Garfias**<br>**TB1:**<br>Durante el desarrollo del TB1, mi principal aporte se centró en la elaboración de diagramas y tablas clave para el análisis del proyecto. Participé activamente en el diseño del modelo C4, así como en la realización de entrevistas a usuarios para obtener información relevante. Estos insumos fueron fundamentales para estructurar la arquitectura del sistema y definir mejor las necesidades del usuario.<br>**TP:** | |
| | **Jhordi Luis Carranza Pérez**<br>**TB1:**<br>Durante el desarrollo del TB1, mi principal aporte fue la elaboración de diagramas, tablas y la realización de entrevistas a usuarios, lo cual permitió profundizar en la comprensión del problema y las necesidades del público objetivo. Además, colaboré activamente en la redacción del informe final, organizando y estructurando la información obtenida para presentar un entregable claro y coherente.<br>**TP:** | |
...
| Categoría                  | SplitEasy (Tu startup)                                                                                         | Splitwise                                                                                       | Tricount                                                                                        | SettleUp                                                                                       |
|---------------------------|----------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------|
...
| EP03     | Panel del Miembro del Hogar   | US14  | Ver historial de pagos     | Como miembro del hogar, quiero consultar un historial de todos mis pagos anteriores para verificar mis contribuciones. | - Escenario 1: Acceso al historial<br>Dado que el usuario quiere ver sus aportes anteriores,<br>Cuando acceda a la sección “Historial de pagos” desde su panel,<br>Entonces verá una lista ordenada cronológicamente con fechas, montos, conceptos y comprobantes de cada pago realizado.<br><br>- Escenario 2: Filtro por periodo<br>Dado que el usuario desea consultar un periodo específico,<br>Cuando seleccione un mes o rango de fechas,<br>Entonces el sistema mostrará únicamente los pagos correspondientes a ese periodo.<br><br>- Escenario 3: Visualización de detalles<br>Dado que el usuario revisa un pago específico,<br>Cuando haga clic sobre un registro,<br>Entonces se desplegarán los detalles completos del aporte (fecha, monto, método de pago, y comprobante si existe).<br><br>- Escenario 4: Accesibilidad<br>Dado que el historial es largo,<br>Cuando navegue por la lista,<br>Entonces podrá usar paginación o scroll infinito para facilitar la navegación. |
                                |
