...
| Categoría                  | SplitEasy (Nuestra startup)                                                                                         | <img src="https://en.wikipedia.org/wiki/Splitwise#/media/File:Splitwise_logo.svg" alt="split" height ="30"> <br> Splitwise                                                                                       | <img src="https://fr.wikipedia.org/wiki/Tricount#/media/Fichier:Tricount-logo.png" alt="split" height ="30"> <br>  Tricount                                                                                        |  <img src="images/SettleUp.png" alt="split" height ="30"> <br> SettleUp                                                                                       |
|---------------------------|----------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------|
